...
vector<vector<int32_t>> LC3372_MaximizeTheNumberOfTargetNodesAfterConnectingTreesI::BuildGraph(
                                                                                ...
                                                                                int32_t parent)
{
    ...
    for (int32_t child : graph[nodeIdx]) {
        if (child == parent) {
            continue;
        }
