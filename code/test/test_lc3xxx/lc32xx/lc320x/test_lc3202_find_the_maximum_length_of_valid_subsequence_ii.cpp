...
{
    std::vector<int32_t> nums = String2VecInt("[1,2,3,4,5]");
    int32_t k = 2;
    int32_t expect = 5;
...
{
    std::vector<int32_t> nums = String2VecInt("[1,4,2,3,1,4]");
    int32_t k = 3;
    int32_t expect = 4;
    RunTest(nums, k, expect);
}
...
{
    std::vector<int32_t> nums = String2VecInt("[2,10]");
    int32_t k = 7;
    int32_t expect = 2;
    RunTest(nums, k, expect);
}
...
{
    std::vector<int32_t> nums = String2VecInt("[1,7,9]");
    int32_t k = 10;
    int32_t expect = 2;
    RunTest(nums, k, expect);
}
...
{
    std::vector<int32_t> nums = String2VecInt("[8,2,8]");
    int32_t k = 5;
    int32_t expect = 3;
    RunTest(nums, k, expect);
}
